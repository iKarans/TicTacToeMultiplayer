...
class TicTacToe:
        ...
        while True:
            ...
            if message == "RESTART":
                ...
                if self.turn != self.player:
                        ...
                        self.mark_square(moveX, moveY, 1)
        ...
        while True:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    sys.exit()
                if event.type == pygame.MOUSEBUTTONDOWN and self.game_over == 0 and not self.counter > 4:
                    if self.turn == self.player:
    ...
    def draw_diagonal_down_line(self):
        pygame.draw.line(self.screen, WIN_LINE_COLOR, (0, 0), (6000, 600), LINE_WIDTH)
